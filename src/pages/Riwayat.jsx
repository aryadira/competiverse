          ...
          <div id='default-carousel' className='relative w-[70vh]' data-carousel='slide'>
            <div className='relative h-auto backdrop-blur-xl overflow-hidden rounded-lg md:h-96'>
              {competitions.map((competition) => (
                <div className='hidden duration-700 ease-in-out' data-carousel-item key={competition.id}>
          ...
          <div className='text-center h-[70vh] p-[10px] w-[100vh] flex items-center'>
            <div>
              <h1 className='text-[50px] font-extrabold'>
                <span className={`${Home.baseColor}`}>Riwayat.</span> Lakukan pendaftaran dengan mudah dan cepat!!
              </h1>
      ...
      <section id='riwayatCard' className='h-auto'>
        ...
        <div id='myTabContent'>
          <div className='hidden p-4 rounded-lg' id='profile' role='tabpanel' aria-labelledby='profile-tab'>
            {competitions.map((competition) => (
              <div className='flex bg-white h-[35vh] w-full p-[15px] my-[10px] relative drop-shadow-md rounded-xl' key={competition.id}>
                ...
                <div className='mx-[20px] my-[10px] w-[100vh] relative'>
                  ...
                  <p
                    className={`text-[20px] bg- transparent w-max p-[5px] rounded-full border ${colorTextCategories.base} ${labelColor(
