...
const Lomba = () => {
  const colorTextCategories = {
    base: "category sm:text-[32px] text-center font-bold flex items-center cursor-pointer",
  ...
  return (
    <>
      ...
      <div className='category-text flex flex-between flex-wrap w-full gap-[20px]'>
